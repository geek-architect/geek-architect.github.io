...
- 创建型模式 
  ...
  - 工厂系列模式(工厂方法，静态工厂方法，抽象工厂)
    ...
    - 视频：[形虽似 魂不同 工厂方法模式好像没啥用](https://www.bilibili.com/video/BV1ZA4y1R7tr)
    - 视频：[5分钟，开发出一个自己的框架 两大设计模式联袂主演 《架构师基本功之设计模式》](https://www.bilibili.com/video/BV1KL4y1P77K)
    - 视频：[5分钟，开发出一个自己的框架-第2集 两大设计模式联袂主演](https://www.bilibili.com/video/BV1bG411s79u)
    - 视频：[5分钟，开发出一个自己的框架-大结局 两大设计模式联袂主演](https://www.bilibili.com/video/BV1ta411W71D)
...
- 行为型模式
  - 状态模式（State Pattern）
    - 文章：[码农老吴基于状态模式重构复杂多变的京东订单状态流转](https://www.bilibili.com/read/cv16247154)
    - 文章：[码农老吴深度解析状态模式冗余代码的化解之道](https://www.bilibili.com/read/cv16346160)
    - 视频：[码农老吴基于状态模式重构复杂多变的京东订单状态流转-第1节](https://www.bilibili.com/video/BV1GT4y1r7uZ)
    - 视频：[码农老吴基于状态模式重构复杂多变的京东订单状态流转-第2节](https://www.bilibili.com/video/BV1k5411m77e)
    - 视频：[码农老吴基于状态模式重构复杂多变的京东订单状态流转-第3节](https://www.bilibili.com/video/BV1dY411P7Cp)
  - 策略模式（Strategy Pattern）
    - 文章：[码农老吴基于策略模式重构京东高并发高风险的促销业务模块](https://www.bilibili.com/read/cv15980509)
    - 文章：[码农老吴基于策略模式+模板方法模式重构京东促销业务模块](https://www.bilibili.com/read/cv16088179)
  ...
  - 模板方法模式（Template method Pattern）
    - 文章：[架构师基本功之设计模式-狗厂百万级订单量的号卡业务-第1期](https://www.bilibili.com/read/cv15592468)
    - 文章：[架构师基本功之设计模式第2期-模板方法重构京东百万级订单量的](https://www.bilibili.com/read/cv15651016)
    - 视频：[码农老吴解密基于模板方法模式的京东百万级订单量的号卡业务-1](https://www.bilibili.com/video/BV1sS4y1g7nf)
    - 视频：[《架构师基本功之设计模式》第2集-码农老吴精讲模板方法模式](https://www.bilibili.com/video/BV1M94y1f7HX)
  - 命令模式（Command Pattern）
    - 文章：[“随风潜入夜，润物细无声” 形容这个设计模式 最为恰当](https://www.bilibili.com/read/cv18401417)
    - 视频：[第一节-“随风潜入夜，润物细无声”形容这个设计模式 最为恰当](https://www.bilibili.com/video/BV1UY4y1T7DM)
    - 视频：[大结局-“随风潜入夜，润物细无声”形容这个设计模式 最为恰当](https://www.bilibili.com/video/BV1L14y1s7Mj)
  - 备忘录模式（Memento Pattern）
    - 文章：[用Java实现Redis的RDB机制 离不开这个设计模式](https://www.bilibili.com/read/cv18485838)
    - 视频：[用Java实现Redis的RDB机制 离不开这个设计模式](https://www.bilibili.com/video/BV1Za4113734)
  - 责任链模式（Chain of Responsibility Pattern）
    - 文章：[基于责任链模式 重构电商营销活动中的会员资格校验模块](https://www.bilibili.com/read/cv18690898)
    - 文章：[基于Commons Chain类库 重构电商营销活动中的会员资格校验模块](https://www.bilibili.com/read/cv18759511)
    - 视频：[基于责任链模式 重构电商营销活动中的会员...](https://www.bilibili.com/video/BV1uB4y1J7nS)
    - 视频：[Apache Commons Chain 专为这个设计模式而生](https://www.bilibili.com/video/BV1Re4y1k7RG)
    - 视频：[下-基于责任链模式的 轻量级开源类库 apache Commons Chain](https://www.bilibili.com/video/BV1CB4y1J7sv)
  - 解释器模式（Interpreter Pattern）
    - 文章：["诗三百" 基于JVM的编程语言 向华为的“仓颉”语言致敬](https://www.bilibili.com/read/cv19028103)
    - 文章：[学了这个设计模式 就可以开发一个自己的编程语言玩玩](https://www.bilibili.com/read/cv19111494)
    - 视频：["诗三百" 基于JVM的脚本语言，向华为的仓颉语言致敬。](https://www.bilibili.com/video/BV1uG41177gx)
    - 视频：[学了这个设计模式 就可以设计一个自己的编程语言玩玩](https://www.bilibili.com/video/BV1h84y1z7Bc)
  - 访问者模式（Visitor Pattern）
    - 文章：[一个让码农道心不稳，走火入魔，破罐子破摔的设计模式](https://www.bilibili.com/read/cv19529298)
    - 视频：[一个容易让码农道心不稳，走火入魔的设计模式](https://www.bilibili.com/video/BV1zg411B7Wh)
  - 迭代器模式（Iterator Pattern）
    - 文章：[JDK集合框架创始人 Google首席java架构师 设计模式的又一贡献](https://www.bilibili.com/read/cv19718986)
    - 视频：[JDK集合框架创始人 Google首席 java架构师 Joshua Bloch 设计模式领域的又一贡献](https://www.bilibili.com/video/BV1Ad4y187dd)
  - 观察者模式（Observer Pattern）
    - 文章：[一个由Java创始人Chris Warth实现的设计模式](https://www.bilibili.com/read/cv19986391)
    - 视频：[埃隆马斯克竟然懂RPC](https://www.bilibili.com/video/BV1jG411u7SX)
    - 视频：[一个浪费了电商平台海量算力资源和网络资源的设计模式](https://www.bilibili.com/video/BV1id4y1x7GC)
